---
description: Create comprehensive implementation plan with deep codebase analysis (GitHub Actions)
allowed-tools:
  - Read
  - Glob
  - Grep
...
**If requirements are unclear**: Note ambiguities in the plan for clarification.
...
> Pay attention to naming of existing utils, types, and models. Import from correct files.
...
**Score below 7?** Note gaps in plan for user review.
